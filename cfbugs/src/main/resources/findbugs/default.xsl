...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\..\..\cfbugs-result.xml" htmlbaseurl="" outputurl="..\..\..\..\..\..\..\temp\x.html" processortype="saxon8" useresolver="yes" profilemode="0"
